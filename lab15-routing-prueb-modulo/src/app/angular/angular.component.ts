...
export class AngularComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.titleService.setTitle('Aplic Web para mostrar caracteristicas Angular');
    this.meta.addTag({
      name: 'author',
    ...
    this.meta.updateTag(
      {
        name: 'description',
        content: 'Esta aplicacion esta desarrollada en Angular version 13.1.1 y bootstrap 5.1.3' +
